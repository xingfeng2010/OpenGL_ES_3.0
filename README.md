...
2.https://www.jianshu.com/p/73630f0c2a28?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation
  RxJava 入门
3.https://www.jianshu.com/p/ceead80495d0?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation
  RxJava 从入门到放弃再到不离不弃

4.https://blog.csdn.net/maplejaw_/article/details/52396175
  RxJava操作符大全
  明天从这里看起走
...
7.浅谈Cordova框架的一些理解
  ...
  对Cordova框架进行了简单分析，可以结合源码进行分析。
==========================================================================================
20180228: 学习Choreographer，跳舞者
==========================================================================================
  1).Choreographer进行帧率统计监测
  ...
  6).Android Choreographer源码分析
    http://blog.csdn.net/sinat_22657459/article/details/52965658
==========================================================================================
20180313: 学习Opengl
  ...
  https://blog.csdn.net/cassiepython/article/details/51606205
==========================================================================================
==========================================================================================
20180314: AudioEffect 音效
  ...
  3）android获取和展示音乐的频谱
     https://www.cnblogs.com/Free-Thinker/p/6078075.html
==========================================================================================
==========================================================================================
...
20180409: Android常用工具类
   ...
   3.NDK开发之文件拆分合并
      https://blog.csdn.net/a1002450926/article/details/79863869
==========================================================================================
==========================================================================================
20180409: Jekins Gradle自动编译
   ...
   4.Jenkins实现Android自动化打包
	 ...
	 这个对安装步骤讲的很详细，并讲到如何把结果上传到fir服务器，通知到钉钉群中。
   5.使用Jenkins进行Android自动打包、
   https://blog.csdn.net/ncepudmx/article/details/77451314

     这个讲到如何在Jenkins中添加参数，并在角本传递参数。
...
20180411: Cordova常用操作
   ...
   4) android5.0(Lollipop) BLE Central牛刀小试
	...
	使用BluetoothLeScanner根据uuid进行过虑搜索
...
20180423:蓝牙低功耗连接 通过BluetoothLeScanner和ScanFilter等来连接
	...
	4）Android BLE的总结-概念篇
	 ...
	 蓝牙协议源码，深入分析，可深入阅读，并不停留在如何使用。
==========================================================================================
==========================================================================================
20180424: 混音器AudioMixer
...
20180427:
	...
	关于内存的，分析的还是比较透彻，对Skia图形引擎也进行了简单的分析。
...
20180428: eclipse打包相关（ant,aapt）
	...
	ant打包，build.xml使用，可以参考，主要参考这个进行操作
...
20180510：android流畅度统计
   ...
   4）android不流畅，究其本质
     https://blog.csdn.net/hanmengaidudu/article/details/18463347
=========================================================================================
20180522：android dex分包
    1）Android Too many classes in --main-dex-list 错误原因及Android分包原理
	  https://www.jianshu.com/p/27319854cd45

	  关于分包及 maindexlist.txt的生成。
...
20180522：重复依赖问题解决
   ...
   2）关于字节 string的转化，在内存的存储，为什么要与0xff.
   ...
   3) [Gradle中文教程系列]-跟我学Gradle-5.3:依赖-管理依赖的版本(传递(transitive)\排除(exclude)\强制(force)\动态版本(+))
	  ...
	  gradle exclude，当出现重复时的解决方法，讲的很好。
=========================================================================================
=========================================================================================
20180601：xxxx.so ： text relocations 问题解决方法 （最新）问题的解决
   ...
   2）libxxx.so- text relocations问题的终极解决方案
	...
	总结：目前都是一种解决方法，说是debug械下，sdk version小于23才会出现，但我目前在自己手机
         并未复制，而在其它手机有较大概率出现。
=========================================================================================
20180612：Android Path学习笔记
   1):Android Path学习笔记
	...
	作者把自己学习path一些用法作了总结，虽然参考了别人的博客，还是值得看看学习下。
  2)三次贝塞尔曲线练习之弹性的圆
...
20180619：Android VR开发
   1):DayDream VR应用开发实践 （第一个android DayDream应用）
     https://blog.csdn.net/sinat_35801282/article/details/60571701
=========================================================================================
Android 博客周刊写的很好，可以多关注。
...
2.https://www.jianshu.com/p/1b1d77f58e84
  Android彻底组件化方案实践

3.http://blog.spinytech.com/2016/12/28/android_modularization/
  Android架构思考(模块化、多进程)
...
5. https://blog.csdn.net/degwei/article/details/79023499
  大型移动应用解决之道 - 插件化

6.https://blog.csdn.net/degwei/article/details/79043165
  Replugin与DroidPlugin框架比较

7.https://www.cnblogs.com/wytiger/p/6837477.html
  Android主要热更新技术原理

  包含分析及一些有用的博客链接。

8.https://www.aliyun.com/jiaocheng/62405.html?spm=5176.100033.1.22.CoIqhZ
...
4.https://www.cnblogs.com/tianzhijiexian/p/4252664.html
  详细解读DiskLruCache
=========================================================================================
20181108 WebKit和Chromium 目前网上在分析的有老罗还有别的人，老罗的分析看起艰涩些。可以先从别人的看起。
...
3.  https://crosswalk-project.org/documentation/about/faq.html

	crosswalk常见问题介绍，其中有关于有些手机不支持webgl解决方法。

4.https://blog.csdn.net/Rong_L/article/details/75212472
  so 动态加载---解决sdk过大问题

  这个博客很重要，可以在后面的过程中多尝试。！！！

5.https://blog.csdn.net/sinat_31057219/article/details/79521374

 音视频开发指南。可以沿着这个方向继续走下去。

6.http://www.music-video.cn/2017/10/10/%E3%80%8A%E9%9F%B3%E8%A7%86%E9%A2%91%E5%BC%80%E5%8F%91%E8%BF%9B%E9%98%B6%E6%8C%87%E5%8D%97-%E5%9F%BA%E4%BA%8Eandroidios%E5%B9%B3%E5%8F%B0%E7%9A%84%E5%AE%9E%E8%B7%B5%E3%80%8B/
  音视频开发进阶指南-基于Android/iOS平台的实践》前言
=========================================================================================
20181123 APM统计

1.https://mp.weixin.qq.com/s?__biz=MzAwNzA0NTMzMQ==&mid=2653201857&idx=1&sn=f1084dc107abef0f4e706fa081d26cd9##
...
6.https://mp.weixin.qq.com/s/6Q818XA5FaHd7jJMFBG60w
  微信Android模块化架构重构实践
7.https://www.jianshu.com/p/f99e5c5fa1a7
  WebView性能、体验分析与优化
...
RePlugin   使用
===============================================================================================
1.https://www.jianshu.com/p/18530be5dcdd
...
4.记录一次完整vue的项目过程
  https://www.jianshu.com/p/f5804394819c
===============================================================================================
...
https://blog.csdn.net/lin_dianwei/article/details/80501339
===============================================================================================
音视频开发指南。可以沿着这个方向继续走下去。
1.《音视频开发进阶指南》—— 读书笔记
...
4.https://blog.csdn.net/sinat_31057219/article/details/79521374
  ...
  Android音视频开发系列文章，开发掌握。
===============================================================================================
1.GreenDao数据库丢失问题：

1.https://blog.csdn.net/qq_35956194/article/details/79167897
...
一旦存入就无法取出，总之，每个 App 自己创建的 key，别的应用是访问不到的。
===============================================================================================

1.https://www.jb51.net/article/92037.htm
  Android 指纹识别详解及实现方法

  这篇关于指纹识别，及两种加密方法，讲解的非常清楚。
...
20190425
===============================================================================================
1.https://www.jianshu.com/p/9a44d04f39fc?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation
...
6.https://www.cnblogs.com/mazhenyu/p/10685202.html
  ...
  系统文章看完，对opengl es会有更深的认识。
7.http://glslsandbox.com/

  有很多用glsl写的很炫的效果，多来看看，一定有收获。
...
2019 0708  状态模式和状态机
=========================================================================================
1.https://www.cnblogs.com/bastard/archive/2012/06/05/2536258.html
...
2019 0708   opengl es
=========================================================================================
1.https://blog.csdn.net/jxt1234and2010/article/details/49110345
  ETC1压缩纹理格式详解
...
=========================================================================================
2019 0719   制定自己团队的前端开发规范
1.https://juejin.im/post/5d300e0fe51d4577407b1dff
制定自己团队的前端开发规范

2.https://www.jianshu.com/u/fd6f2b25d0f4
...
1.https://blog.csdn.net/shuijianbaozi/article/details/78949236
...
2019 0918  组件化
=========================================================================================
1.http://prototypez.github.io/2018/09/15/app-joint-introduction/
  回归初心：极简 Android 组件化方案 — AppJoint、
...
6.https://blog.klmobile.app/2018/02/27/design-an-elegant-and-powerful-android-webview-part-two/
  如何设计一个优雅健壮的Android WebView？（下）基于考拉电商平台的WebView实践
=========================================================================================
...
2020 0513  组件化  MVVM
=========================================================================================
1.2020年开春最新面试！今日头条 Android 面试题及答案
  https://blog.csdn.net/Aerfa789/article/details/104335324

2.2020阿里大佬总结面试题系列！大厂面试之图片
...
=========================================================================================
2020 0901  Android开发辅助
=========================================================================================
1.Android SDK开发艺术探索（七）依赖原则与打包方法
...
=========================================================================================
2020 0901  Android GUI系统
=========================================================================================
1.https://www.cnblogs.com/blogs-of-lxl/p/11443693.html
...
9.https://cloud.tencent.com/document/product/548/36674#.E5.A6.82.E4.BD.95.E8.AE.BE.E7.BD.AE.E6.B6.88.E6.81.AF.E7.82.B9.E5.87.BB.E4.BA.8B.E4.BB.B6.EF.BC.9F
  信鸽应用杀死不跳转
...
2.FFmpeg 开发(03)：FFmpeg + OpenSLES 实现音频解码播放
...
4.http://hk.uwenku.com/question/p-txrpazks-bm.html
  Android：如何更改使用OpenSL ES的音樂播放速率

5.AV_PIX_FMT_YUV420P与AV_PIX_FMT_YUVJ420P
  http://www.voidcn.com/article/p-zsuqhmge-bqk.html

6.https://github.com/tencentyun/qcloud-documents/blob/master/product/%E7%A7%BB%E5%8A%A8%E4%B8%8E%E9%80%9A%E4%BF%A1/%E8%85%BE%E8%AE%AF%E7%A7%BB%E5%8A%A8%E6%8E%A8%E9%80%81/%E6%93%8D%E4%BD%9C%E6%8C%87%E5%8D%97/%E6%8E%92%E6%9F%A5%E5%B7%A5%E5%85%B7%E4%BD%BF%E7%94%A8.md
  腾讯.md 文件，可作为标准借鉴

7.https://www.jianshu.com/p/2d45c09600a2
  OpenGL文档翻译：FBO
...
1.clean architecture的核心思想
https://blog.csdn.net/nanyi545/article/details/50971153

2.Android-CleanArchitecture
  https://github.com/android10/Android-CleanArchitecture
=========================================================================================
2020 10 29  activity viewapge fragment 应用回收
=========================================================================================
1.https://www.jianshu.com/p/fee285b06479
...
=========================================================================================
=========================================================================================
2020 10 29  Android Studio 内存泄露问题分析及MAT工具使用
=========================================================================================
1.https://blog.csdn.net/junhuahouse/article/details/79731529
...
=========================================================================================
2020 11 20  三方SDK集成原则

1.https://zhuanlan.zhihu.com/p/74436725
  接入第三方SDK需要注意哪些事项
=========================================================================================
=========================================================================================
2021 01 14  Android 屏幕适配

1.https://zhuanlan.zhihu.com/p/47446799
  今日头条屏幕适配方案终极版正式发布!

2.https://mp.weixin.qq.com/s?__biz=MzI3OTU0MzI4MQ==&mid=2247486334&idx=1&sn=1a3189739bc0ad984f67e18c09f35055&chksm=eb4767e0dc30eef6fea34d891fca87b95edf5a834d5b8a3612f0e3700690e21607eb41499bf1&scene=21#wechat_redirect
...
9.Android kotlin 使用协程配合Retrofit进行网络请求
...
10.https://blog.csdn.net/sunluyao_/article/details/101318799
   真香！Kotlin+MVVM+LiveData+协程 打造 Wanandroid！
11.https://juejin.cn/post/6844903949686800392
   Kotlin 的协程用力瞥一眼

12.https://blog.csdn.net/qq_39424143/article/details/106887595
   简单天气--Kotlin+JetPack+协程+MVVM架构

13.https://www.jianshu.com/p/bb63f889200e
14.https://www.jianshu.com/p/4c9f7dcdce55
15.https://blog.csdn.net/zhong_zihao/article/details/105145206
  =========================================================================================
2021 01 25  Android 应用开发安全规范

1.https://blog.csdn.net/milllulei/article/details/81185149
  Android安全开发规范
...
1.https://blog.csdn.net/hj7jay/article/details/84527062
  Git分支模型(master/hotfix/develop/feature/release)

=========================================================================================
2021 01 22  Android OKHttp Intercept

1.https://blog.csdn.net/u010312474/article/details/103620710
  OKHTTP加拦截Interceptor 刷新token

2.https://www.cnblogs.com/guojing1991/p/4845011.html
  JustifyTextView 解决TextView中英文混排自动换行的问题
=========================================================================================
2021 03 29 Android SDK 开发
...
=========================================================================================
2021 04 12  Android 接口设计

1.https://blog.bihe0832.com/sdk_desigin_api.html
  SDK设计心得之接口设计
...
7.https://mp.weixin.qq.com/s?__biz=MzIxMTg5NjQyMA==&mid=2247501618&idx=1&sn=6f753aab3a413b596f23b67c06ffa226&chksm=974cd639a03b5f2f0618b1b3e13805fbbae27ad943ee0101bbc78b08dee90f18eed55d12c361&scene=21#wechat_redirect
...
=========================================================================================
2021 05 19  Android Studio Gradle离线使用
            编译速度优化提升

1.https://zhuanlan.zhihu.com/p/26473930
...
8.https://blog.csdn.net/JadynAi/article/details/80978834
