...
public class Celestial {
    ...
    public void initShader(View view) {
        mVertexShader = ShaderUtil.loadFromAssetsFile("chapter7/chapter7.5/vertex_xk.glsl", view.getResources());
        mFragmentShader = ShaderUtil.loadFromAssetsFile("chapter7/chapter7.5/frag_xk.glsl", view.getResources());
