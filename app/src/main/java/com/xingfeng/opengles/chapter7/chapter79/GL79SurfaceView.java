...
import com.xingfeng.opengles.util.ConvertUtil;
...
class GL79SurfaceView extends GLSurfaceView
{
    ...
    public GL79SurfaceView(Context context)
    {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //创建点对象
            point=new ArrayPoints(GL79SurfaceView.this);
            //打开深度检测
