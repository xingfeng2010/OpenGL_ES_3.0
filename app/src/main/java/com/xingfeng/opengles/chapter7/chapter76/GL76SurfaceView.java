...
public class GL76SurfaceView extends GLSurfaceView {
    ...
    public GL76SurfaceView(Context context) {
        super(context);
    ...
    {
        TextureTriangle2 texRect;//纹理三角形对象引用
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect=new TextureTriangle2(GL76SurfaceView.this);
            //打开深度检测
