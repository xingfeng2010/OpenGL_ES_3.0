...
public class GL75SurfaceView extends GLSurfaceView {
    ...
    public GL75SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建地球对象
            earth=new Earth(GL75SurfaceView.this,2.0f);
            //创建月球对象
            moon=new Moon(GL75SurfaceView.this,1.0f);
            //创建小星星天球对象
            cSmall=new Celestial(1,0,1000,GL75SurfaceView.this);
            //创建大星星天球对象
            cBig=new Celestial(2,0,500,GL75SurfaceView.this);
            //打开深度检测
