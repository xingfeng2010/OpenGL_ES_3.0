...
public class ArrayPoints {
    ...
    public void initVertexData()
    {
        ...
        float vertices[] = new float[] {
                ...
                UNIT_SIZE*4/5, -UNIT_SIZE*2, 0,
                -UNIT_SIZE*4/5, -UNIT_SIZE*2, 0,
                -UNIT_SIZE*5/4, -UNIT_SIZE*2.2f, 0,
                UNIT_SIZE*5/4, -UNIT_SIZE*2.2f, 0,
                -UNIT_SIZE*1.3f, -UNIT_SIZE*2.6f, 0,
                UNIT_SIZE*1.3f, -UNIT_SIZE*2.6f, 0,
                0, -UNIT_SIZE*2.6f, 0,
    ...
    public void initShader(View mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("chapter7/chapter7.9/vertex.glsl",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("chapter7/chapter7.9/frag.glsl",
                mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
