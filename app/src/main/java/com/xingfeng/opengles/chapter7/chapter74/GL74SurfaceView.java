...
import com.xingfeng.opengles.chapter7.chapter73.TextureRect;
...
public class GL74SurfaceView extends GLSurfaceView {
    ...
    public GL74SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建纹理矩形对象
            texRect = new NormalRect(GL74SurfaceView.this);
            //打开深度检测
