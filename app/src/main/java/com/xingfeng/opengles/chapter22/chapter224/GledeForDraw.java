...
public class GledeForDraw
{
    ...
    //初始化顶点数据的方法
    public void initVertexData(View mv)
    {
        //加载雄鹰模型
        glede_one= LoadUtil.loadFromFileVertexOnly("chapter202/chapter202.4/laoying01.obj",mv);
        glede_two=LoadUtil.loadFromFileVertexOnly("chapter202/chapter202.4/laoying02.obj",mv)[0];
        glede_three=LoadUtil.loadFromFileVertexOnly("chapter202/chapter202.4/laoying03.obj",mv)[0];
