...
@SuppressLint("NewApi")
class GL221SurfaceView extends GLSurfaceView
{
    ...
    @SuppressLint("NewApi")
    public GL221SurfaceView(Context context) {
        super(context);
    ...
    class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建纹理矩形对对象
            texRect=new FlagRect(GL221SurfaceView.this);
            //打开深度检测
            GLES30.glEnable(GLES30.GL_DEPTH_TEST);
            //初始化纹理
            textureFlagId=initTexture(R.drawable.flag);
            //关闭背面剪裁
