...
import com.xingfeng.opengles.chapter22.chapter224.GledeForDraw;
import com.xingfeng.opengles.util.LoadUtil;
import com.xingfeng.opengles.util.LoadedObjectVertexNormalTexture;
import com.xingfeng.opengles.util.LoadedObjectVertexNormalTexture6;
...
public class GL226SurfaceView extends GLSurfaceView {
    ...
    public GL226SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer
    {
        ...
        //从指定的obj文件中加载对象
        LoadedObjectVertexNormalTexture6 lovo;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
           ...
           //加载要绘制的物体
            lovo = LoadUtil.loadFromFile6("chapter202/chapter202.6/head.obj", getResources(), GL226SurfaceView.this);
            //加载纹理
            textureId=initTexture(R.drawable.head);
        }
    }
