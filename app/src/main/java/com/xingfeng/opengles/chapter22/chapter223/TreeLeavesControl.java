...
public class TreeLeavesControl implements Comparable<TreeLeavesControl>
{
    ...
    {
        //当前树叶距离摄像机的距离
        float distanceX=(this.positionX+this.treeLeaves.centerX-GL223SurfaceView.cx)*(this.positionX+this.treeLeaves.centerX-GL223SurfaceView.cx);
        float distanceZ=(this.positionZ+this.treeLeaves.centerZ-GL223SurfaceView.cz)*(this.positionZ+this.treeLeaves.centerZ-GL223SurfaceView.cz);
        //比较点距离摄像机的距离
        float distanceOX=(another.positionX+another.treeLeaves.centerX-GL223SurfaceView.cx)*(another.positionX+another.treeLeaves.centerX-GL223SurfaceView.cx);
        float distanceOZ=(another.positionZ+another.treeLeaves.centerZ-GL223SurfaceView.cz)*(another.positionZ+another.treeLeaves.centerZ-GL223SurfaceView.cz);
