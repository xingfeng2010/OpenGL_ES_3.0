...
public class Chapter223Activity extends GLRenderActivity {
    private GL223SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //初始化GLSurfaceView
        mGLSurfaceView = new GL223SurfaceView(this);
        ...
        switch(id)
        {
            case 0://生成普通对话框的代码
                ...
                b.setPositiveButton//为对话框设置按钮
                        (
                                "确定",
                                (dialog1, which) -> Constant.wind_direction=sb.getProgress()
                        );
                dialog=b.create();
                break;
            case 1://生成普通对话框的代码
                ...
                b.setPositiveButton//为对话框设置按钮
                        (
                                "确定",
                                (dialog12, which) -> Constant.setWindForce(sb1.getProgress())
                        );
                dialog=b.create();
                break;
        }
