...
public class GameSurfaceView extends GLSurfaceView {
    ...
    class SceneRenderer implements GLSurfaceView.Renderer
    {
        public void onDrawFrame(GL10 gl)
        {
            ...
            //将三角形移动到屏幕中心
            float upOffset= (float) (Constant.triangle_edgeLength/2/Math.cos(Math.PI/6));
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载shader
            ShaderManager2.loadCodeFromFile(GameSurfaceView.this.getResources());
            //编译shader
            ShaderManager2.compileShader();
    ...
    {
        trangle=new MultiTrangle(ShaderManager2.getTrangleShaderProgram(),
                Constant.triangle_edgeLength, Constant.triangle_levelNum);
    }
    //初始化所有的纹理图形
    public void initAllTexture()
    {
        Resources r=this.getResources();//获取资源
        tex_trangleId=Constant.initTexture(r,R.drawable.android);//草地纹理
    }
}
