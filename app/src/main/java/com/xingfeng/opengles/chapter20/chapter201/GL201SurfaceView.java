...
public class GL201SurfaceView extends GLSurfaceView {
    ...
    public GL201SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo1= LoadUtil.loadFromFile("chapter201/chapter201.1/ch_t.obj", GL201SurfaceView.this.getResources(),GL201SurfaceView.this);
            lovo2=LoadUtil.loadFromFile("chapter201/chapter201.1/rg.obj", GL201SurfaceView.this.getResources(),GL201SurfaceView.this);
            //加载纹理
