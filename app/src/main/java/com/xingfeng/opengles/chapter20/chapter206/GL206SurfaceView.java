...
import com.xingfeng.opengles.chapter20.chapter205.TextureRect5;
...
public class GL206SurfaceView extends GLSurfaceView {
    ...
    public GL206SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void drawShadowTexture() {
            ...
            //调用此方法产生摄像机9参数位置矩阵
            MatrixState.setCamera(0,0,100,0f,0f,0f,0f,1.0f,0.0f);
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            initFBO();
            textureIdsGHXP = initTexture(R.drawable.ghxp);
            tr = new TextureRect5(GL206SurfaceView.this, ratio);
        }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo=LoadUtil.loadFromFile5("chapter201/chapter201.6/ch_t.obj", GL206SurfaceView.this.getResources(),GL206SurfaceView.this);
        }
    }
    public int initTexture(int drawableId)//textureIds
    {
        //生成纹理ID
