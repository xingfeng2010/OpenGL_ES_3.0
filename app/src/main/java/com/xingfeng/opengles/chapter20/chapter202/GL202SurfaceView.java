...
public class GL202SurfaceView extends GLSurfaceView {
    ...
    public GL202SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        //从指定的obj文件中加载对象
        LoadedObjectVertexNormalTexture2 lovo1;
        LoadedObjectVertexNormalTexture2 lovo2;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo1= LoadUtil.loadFromFile2("chapter201/chapter201.2/ch_t.obj", GL202SurfaceView.this.getResources(),GL202SurfaceView.this);
            lovo2=LoadUtil.loadFromFile2("chapter201/chapter201.2/pingzi.obj", GL202SurfaceView.this.getResources(),GL202SurfaceView.this);
            //加载纹理
