...
public class GL203SurfaceView extends GLSurfaceView {
    ...
    public GL203SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo=LoadUtil.loadFromFile3("chapter201/chapter201.3/rg.obj", GL203SurfaceView.this.getResources(),GL203SurfaceView.this);
            //加载纹理
