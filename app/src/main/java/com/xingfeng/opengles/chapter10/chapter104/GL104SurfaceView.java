...
public class GL104SurfaceView extends GLSurfaceView {
    ...
    public GL104SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建地球对象
            earth=new Earth(GL104SurfaceView.this,2.0f);
            //创建月球对象
            moon=new Moon(GL104SurfaceView.this,1.0f);
            //创建小星星天球对象
            cSmall=new Celestial(1,0,1000,GL104SurfaceView.this);
            //创建大星星天球对象
            cBig=new Celestial(2,0,500,GL104SurfaceView.this);
            cloud = new Cloud(GL104SurfaceView.this, 2.02f);
            //打开深度检测
    ...
    public int initTexture(int drawableId)//textureId
    {
        ...
        //通过输入流加载图片===============begin===================
        Bitmap bitmapTmp = BitmapFactory.decodeResource(this.getResources(), drawableId);
        //通过输入流加载图片===============end=====================
