...
public class Moon {
    ...
    public void initShader(View view) {
        mVertexShader = ShaderUtil.loadFromAssetsFile("chapter10/chapter10.4/vertex_moon.sh",view.getResources());
        mFragmentShader = ShaderUtil.loadFromAssetsFile("chapter10/chapter10.4/frag_moon.sh",view.getResources());
