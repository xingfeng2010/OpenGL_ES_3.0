...
class GL102SurfaceView extends GLSurfaceView
{
	...
	private KeyThread2 keyThread;
	public GL102SurfaceView(Context context) {
        super(context);
	...
	private class SceneRenderer implements Renderer
    {
		...
		public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            keyThread = new KeyThread2(GL102SurfaceView.this);
            keyThread.start();
        }
        @SuppressLint("NewApi")
		@Override
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //����id
            rectTexId=initTexture(R.raw.lgq2);
            //����Ҫ���Ƶ�����
            ch= LoadUtil.loadFromFileVertexOnlyAverage("chapter10/chapter10.1/ch.obj", GL102SurfaceView.this.getResources(),GL102SurfaceView.this);
            pm=LoadUtil.loadFromFileVertexOnlyFace("chapter10/chapter10.1/pm.obj", GL102SurfaceView.this.getResources(),GL102SurfaceView.this);;
    		cft=LoadUtil.loadFromFileVertexOnlyFace("chapter10/chapter10.1/cft.obj", GL102SurfaceView.this.getResources(),GL102SurfaceView.this);;
    		qt=LoadUtil.loadFromFileVertexOnlyAverage("chapter10/chapter10.1/qt.obj", GL102SurfaceView.this.getResources(),GL102SurfaceView.this);;
    		yh=LoadUtil.loadFromFileVertexOnlyAverage("chapter10/chapter10.1/yh.obj", GL102SurfaceView.this.getResources(),GL102SurfaceView.this);;
    		rect = new MixTextureRect2(GL102SurfaceView.this, 10, 10);
        }  
    }
