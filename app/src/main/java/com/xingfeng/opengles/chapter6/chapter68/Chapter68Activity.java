package com.xingfeng.opengles.chapter6.chapter68;
...
public class Chapter68Activity extends GLRenderActivity {

    private GL68SurfaceView mGLSurfaceView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new GL68SurfaceView(this);
        // 切换到主界面
