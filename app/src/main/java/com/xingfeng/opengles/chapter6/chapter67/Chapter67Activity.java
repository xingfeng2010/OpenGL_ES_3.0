package com.xingfeng.opengles.chapter6.chapter67;
...
public class Chapter67Activity extends GLRenderActivity {

    private GL67SurfaceView mGLSurfaceView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new GL67SurfaceView(this);
        // 切换到主界面
