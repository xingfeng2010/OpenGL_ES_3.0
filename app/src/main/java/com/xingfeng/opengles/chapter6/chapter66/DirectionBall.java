package com.xingfeng.opengles.chapter6.chapter66;
...
public class DirectionBall {
    ...
    int maLightDirectionHandle;//光源位置属性引用
    int maCameraHandler; //摄像机位置属性引用
    ...
    public void initShader(View mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("chapter6/chapter6.6/vertex.glsl",mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("chapter6/chapter6.6/frag.glsl",mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
        ...
        maLightDirectionHandle = GLES30.glGetUniformLocation(mProgram, "uLightDirection");

        maCameraHandler = GLES30.glGetUniformLocation(mProgram, "uCamera");
    }
    ...
    public void drawSelf()
    {
        ...
        GLES30.glUniform3fv(maCameraHandler, 1, MatrixState.cameraFB);
        // 将最终变换矩阵传入渲染管线
        ...
        // 将光源位置传入渲染管线
        GLES30.glUniform3fv(maLightDirectionHandle,1, MatrixState.lightPositionFB);
