...
import com.xingfeng.opengles.util.LoadedObjectVertexNormalTexture8;
import com.xingfeng.opengles.util.MatrixState;

public class GL278SurfaceView extends GLSurfaceView {
    ...
    public GL278SurfaceView(Activity context) {
        super(context);
        initWorld(); //初始化物理世界
    ...
    {
        LoadedObjectVertexNormalTexture8 pm;//加载的地面
        LoadedObjectVertexNormalTexture8 vehicleBox;
        LoadedObjectVertexNormalTexture8 vehicleWheel;
        LoadedObjectVertexNormalTexture8 boxTexture;
        LoadedObjectVertexNormalTexture8 pailTexture;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            land = initTexture(R.drawable.grass, GL278SurfaceView.this);//加载草皮纹理
            vehicleTextureId = initTexture(R.drawable.car, GL278SurfaceView.this);
            boxId = initTexture(R.drawable.box, GL278SurfaceView.this);
            pailId = initTexture(R.drawable.pail, GL278SurfaceView.this);
            //加载车身obj模型
            vehicleBox = LoadUtil.loadFromFile("chapter701/chapter701.8/carBox.obj", GL278SurfaceView.this.getResources(), GL278SurfaceView.this);
            vehicleWheel = LoadUtil.loadFromFile("chapter701/chapter701.8/carWheel.obj", GL278SurfaceView.this.getResources(), GL278SurfaceView.this);
            boxTexture = LoadUtil.loadFromFile("chapter701/chapter701.8/cube.obj", GL278SurfaceView.this.getResources(), GL278SurfaceView.this);
            pailTexture = LoadUtil.loadFromFile("chapter701/chapter701.8/tong.obj", GL278SurfaceView.this.getResources(), GL278SurfaceView.this);
            //新建汽车对象
            ...
            tf = new TextFloor(30, 0, GL278SurfaceView.this);//新建绘制地面的对象
        }
    }

    public static int initTexture(int drawableId, View gsv)//textureId
    {
        //生成纹理ID
