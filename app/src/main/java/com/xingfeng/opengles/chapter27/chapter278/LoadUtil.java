...
import com.xingfeng.opengles.util.Normal;
...
public class LoadUtil {
    ...
    public static LoadedObjectVertexNormalTexture8 loadFromFile
    (String fname, Resources r, View mv) {
        //加载后物体的引用
        LoadedObjectVertexNormalTexture8 lo = null;
        ...
        try {
            ...
            //创建3D物体对象
            lo = new LoadedObjectVertexNormalTexture8(mv, vXYZ, nXYZ, tST);
        } catch (Exception e) {
    ...
    //从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
    public static LoadedObjectVertexNormalTexture8 loadFromFileVel
    (String fname, Resources r, View mv) {
        //加载后物体的引用
        LoadedObjectVertexNormalTexture8 lo = null;
        //原始顶点坐标列表--直接从obj文件中加载
