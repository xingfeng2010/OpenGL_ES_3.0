...
public class Car {
    ...
    com.xingfeng.opengles.chapter27.chapter278.Vector3f carStartPoint;
    ...
    public Car(
            DynamicsWorld dynamicsWorld,    //物理世界
            LoadedObjectVertexNormalTexture8 vBox,//从Obj文件中加载的车身模型
            LoadedObjectVertexNormalTexture8 vWheel,//从Obj文件中加载的车轮模型
            int vehicleTextureId,//汽车的纹理Id
            com.xingfeng.opengles.chapter27.chapter278.Vector3f carStartPoint    //汽车初始位置
    ) {
    ...
    public void updateCamera1() {
        ...
        com.xingfeng.opengles.chapter27.chapter278.Vector3f start = new com.xingfeng.opengles.chapter27.chapter278.Vector3f(0, 0, 6);
        com.xingfeng.opengles.chapter27.chapter278.Vector3f end = new com.xingfeng.opengles.chapter27.chapter278.Vector3f(0, 0, 0);
        com.xingfeng.opengles.chapter27.chapter278.Vector3f end2;
        ...
        com.xingfeng.opengles.chapter27.chapter278.Vector3f cam = new com.xingfeng.opengles.chapter27.chapter278.Vector3f(end2.x * 1.0f, end2.y, end2.z * 1.0f);
...
//		 MatrixState.scale(-1, 1, 1);
    ...
    public void updateCamera2() {
        ...
        if (camera_angle <= 4 && camera_angle >= -4)//摄像机跟随
        {
            ...
            end2 = end.roty(Math.toRadians(-camera_angle * rayVehicle.getCurrentSpeedKmHour() / 2000));
        com.xingfeng.opengles.chapter27.chapter278.Vector3f cam = new com.xingfeng.opengles.chapter27.chapter278.Vector3f(-end2.x * 1.0f, end2.y + 4.0f, -end2.z * 1.0f);
