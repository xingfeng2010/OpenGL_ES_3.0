...
public class Box {
    ...
    LoadedObjectVertexNormalTexture8 rbobj;//箱子模型
    int vehicleTextureId;//纹理id
    RigidBody rb;
    float[] f = new float[4];

    public Box(float rx, float ry, float rz, float rbangle, DynamicsWorld dynamicsWorld,
               LoadedObjectVertexNormalTexture8 rbobj, int vehicleTextureId, CollisionShape rbShape) {
        this.rx = rx;
        this.ry = ry;
        this.rz = rz;
        //this.rl = rl;
        ...
        rb = localCreateRigidBody(10, rbTransform, rbShape);//获得刚体
    }
