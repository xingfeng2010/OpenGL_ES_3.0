...
//加载后的物体——仅携带顶点信息，颜色随机
public class LoadedObjectVertexNormalTexture6
{
    ...
    float fatFacrorStep=0.001f;//膨胀系数步进

    public LoadedObjectVertexNormalTexture6(View mv, float[] vertices, float[] normals, float texCoors[])
    {
        //初始化顶点坐标与着色数据
    ...
    public void drawSelf(int texId)
    {
        ...
        if(fatFacror>0.05f||fatFacror<0f)//若膨胀系数达到上限或下限
        {
