...
//加载后的物体――仅携带顶点信息，颜色随机
@SuppressLint("NewApi") public class LoadedObjectVertexNormalTexture5
{
    ...
    public LoadedObjectVertexNormalTexture5(View mv,float[] vertices,float[] normals,float texCoors[])
    {
        this.mv=mv;
        //初始化顶点数据的方法
