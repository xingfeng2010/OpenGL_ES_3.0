...
class GL512SurfaceView extends GLSurfaceView
{
    ...
    public GL512SurfaceView(Context context) {
        super(context);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE://若为移动动作
                ...
                for(VertexSixPointedStar h:mRenderer.ha)//设置各个六角星绕x轴、y轴旋转的角度
                {
    ...
    {
        VertexSixPointedStar[] ha=new VertexSixPointedStar[6];//六角星数组
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            {
                ha[i]=new VertexSixPointedStar(GL512SurfaceView.this,0.4f,1.0f,-1.0f*i, color[i]);
            }
            //打开深度检测
