...
public class GL57SurfaceView extends GLSurfaceView{
    private SceneRenderer mRenderer;//场景渲染器

    public float ratio;
    public GL57SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建圆对象
            circle=new Circle(GL57SurfaceView.this);
            //创建条状物对象
            belt=new Belt(GL57SurfaceView.this);
            //打开深度检测
