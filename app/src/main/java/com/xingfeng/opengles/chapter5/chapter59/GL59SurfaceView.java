...
public class GL59SurfaceView extends GLSurfaceView{
    private SceneRenderer mRenderer;//场景渲染器

    public float ratio;
    public GL59SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建圆对象
            circle=new IndexCircle(GL59SurfaceView.this);
            //创建条状物对象
            belt=new IndexBelt(GL59SurfaceView.this);
            //打开深度检测
