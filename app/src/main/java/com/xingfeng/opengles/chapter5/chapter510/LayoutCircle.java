...
public class LayoutCircle {
    ...
    public void initShader(View mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("layout_vertex.glsl",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("layout_frag.glsl",
                mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
    ...
    public void drawSelf() {
        ...
        // 绘制图形
        GLES30.glDrawElements(GLES30.GL_TRIANGLES, iCount, GLES30.GL_UNSIGNED_BYTE, mIndexBuffer);//用索引法绘制图形
    }
}
