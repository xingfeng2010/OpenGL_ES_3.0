...
class GL515SurfaceView extends GLSurfaceView
{
    ...
    public GL515SurfaceView(Context context) {
        super(context);
    ...
    {
        MultiColorRect color1;//平面对象1引用
        MultiColorRect color2;//平面对象2引用
...
//            GLES30.glPolygonOffset ( polygonOffsetFactor, polygonOffsetUnits );
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            color1=new MultiColorRect(GL515SurfaceView.this,new float[]{0,1,1,0});//蓝色
            color2=new MultiColorRect(GL515SurfaceView.this,new float[]{1,1,0,0});//黄色
            //打开深度检测
